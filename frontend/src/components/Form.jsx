        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`border p-2 rounded-md ${
                  fieldErrors.familyName ? "border-red-500" : "border-gray-300"
                }`}
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`border p-2 rounded-md ${
                  fieldErrors.birthday ? "border-red-500" : "border-gray-300"
                }`}
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                className={`border p-2 rounded-md ${
                  fieldErrors.regNumber ? "border-red-500" : "border-gray-300"
                }`}
              />
          ...
          <div className="flex justify-end gap-3 pt-4 ">
            ...
            <button
              ...
              disabled={loading}
              className="px-4 py-2 cursor-pointer rounded-md bg-green-500 text-white hover:bg-green-600 disabled:opacity-50"
            >
